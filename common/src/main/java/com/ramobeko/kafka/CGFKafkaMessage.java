...
public class CGFKafkaMessage {
    ...
    public CGFKafkaMessage(UsageType usageType, double usageAmount, String senderSubscNumber, String receiverSubscNumber, Date usageTime) {
